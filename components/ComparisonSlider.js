...
const ComparisonSlider = () => {
  ...
  return (
    <div className="aspect-h-9 aspect-w-16 overflow-x-hidden ">
      <div ref={imageContainer} className="my10  px-4">
        <Image
          src="https://static1.squarespace.com/static/60be3f15c04ff53428559e91/t/62084f386f98284656405b54/1644711737168/Done-2.jpg"
          alt="before"
          layout="fill"
          objectFit="cover"
          className="group pointer-events-none relative select-none overflow-hidden"
        />
      </div>
      <div
        style={{
